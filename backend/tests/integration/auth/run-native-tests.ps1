...
$testEnvironment = @{
    ...
    SECURITY_WS_CONNECTION_MAXIMUM = '100'
    SECURITY_OUTBOX_BATCH_SIZE = '50'
    SECURITY_OUTBOX_MAX_ATTEMPTS = '3'
    SECURITY_OUTBOX_RETRY_BASE_MS = '25'
    SECURITY_OUTBOX_POLL_INTERVAL_MS = '1000'
    SECURITY_OUTBOX_LEASE_MS = '10000'
